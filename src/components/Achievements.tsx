...
const cards = [
  {
    ...
    description: "Scholarly publications and patented research in AI-driven meteorological systems and machine learning frameworks.",
  ...
  },
  {
    ...
    description: "Professional certifications from Hugging Face, Anthropic, and other leading AI research institutions.",
